...
def calculate_infections(starting_number_infections, reproduction_rate, num_days):
    ...
    number_of_infected = starting_number_infections * reproduction_rate
    for i in range(num_days-1):
        number_of_infected = number_of_infected * reproduction_rate
    
    return(int(format(number_of_infected, '.0f')))
